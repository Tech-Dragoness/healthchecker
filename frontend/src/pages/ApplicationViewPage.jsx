// HealthChecker/frontend/src/pages/ApplicationViewPage.jsx
...
export default function ApplicationViewPage() {
  ...
  const isFallback = app.remarks_is_fallback;
    ...
    <>
      ...
      <div className="page-wrapper container" style={{ maxWidth: 760 }}>
        ...
        <div className="section-header">
          <div>
            <h2 className="section-title" style={{ fontFamily: "monospace" }}>
              {app.app_ref}
            </h2>
        ...
        <div className="card mb-2">
          ...
          <div className="detail-grid">
            ...
            <div>
              ...
              <span>{formatDate(app.date_of_birth)}</span>
            </div>
            <div>
            ...
            <div>
              <span className="detail-label">Age at Submission</span>
              <span>{app.age_at_submission} years</span>
            </div>
          </div>
        </div>
        ...
        <div className="card mb-2">
          ...
          <div className="detail-grid">
            <div>
              ...
              <span>{app.glucose} mg/dL</span>
            </div>
            <div>
              <span className="detail-label">Haemoglobin</span>
              <span>{app.haemoglobin} g/dL</span>
            </div>
            <div>
              <span className="detail-label">Cholesterol</span>
              <span>{app.cholesterol} mg/dL</span>
            </div>
            <div>
              <span className="detail-label">Risk Tag</span>
              {app.risk_tag ? (
                <span className={`badge ${RISK_BADGE_CLASS[app.risk_tag]}`}>
                  {RISK_LABELS[app.risk_tag]}
                </span>
              ) : (
        ...
        <div className="card">
          ...
          <p className="remarks-greeting">
            Hi {firstName}, here's
            a summary of your blood test results.
          </p>
          {(isFallback && (
            <div className="alert alert-warning mb-2">
              ⚠ Automated AI analysis was unavailable for this application — the
              remark below was generated automatically from simple
              reference-range comparison only.
            </div>
          )) || (
            <div
